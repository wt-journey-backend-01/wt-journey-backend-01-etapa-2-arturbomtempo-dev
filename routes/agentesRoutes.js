 ...
 *                  example: []
 */
router.get('/agentes/:id', validateUUIDParam('id'), validateRequest, agentesController.getAgenteById);
 ...
 *                  example: []
 */
router.delete('/agentes/:id', validateUUIDParam('id'), validateRequest, agentesController.deleteAgente);
